...
| =clatter-unified-hide=        | =nil=     | Hide nothing, visible windows, or a list |
...
- =clatter-unified-hide= can also collapse sources you are already looking at
  (='visible=) or a list of channel/query names. The text stays in the buffer;
  changing the option brings it back.
